...
{
    GPIO_WriteBit(BOARD_LCD_CS_PORT, BOARD_LCD_CS_PIN, (high) ? Bit_SET : Bit_RESET);
}

static void set_wr(bool high)
{
    GPIO_WriteBit(BOARD_LCD_WR_PORT, BOARD_LCD_WR_PIN, (high) ? Bit_SET : Bit_RESET);
}

static void set_data(bool high)
{
    GPIO_WriteBit(BOARD_LCD_DATA_PORT, BOARD_LCD_DATA_PIN, (high) ? Bit_SET : Bit_RESET);
}
